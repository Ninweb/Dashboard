...
//     Route::post('usuarios/{usuario}','UsuarioController@update');
...
//     Route::post('empleados/{empleado}','EmpleadoController@update');
...
//     Route::post('personas/{persona}','PersonaController@update');
...
//     Route::post('departamentos/{departamento}','DepartamentoController@update');
...
//     Route::post('direcciones/{direccion}','DireccionController@update');
